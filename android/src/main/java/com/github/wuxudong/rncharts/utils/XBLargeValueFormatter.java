 ...
 */
 ...
 // 
public class XBLargeValueFormatter extends ValueFormatter
{
     ...
     */
    public XBLargeValueFormatter(String appendix) {
        this();
        mText = appendix;
    }
    ...
    public String getFormattedValue(float value) {
        if (value > 999) return makePretty(value) + mText;
